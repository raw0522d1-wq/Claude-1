...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    id: 'perfect-week',
    title: 'PERFECT WEEK',
    requirement: 'Hit your weekly workout target',
    reward: 'Week-streak counter ignited + bonus mulligan pride',
    rewardIcon: '🔥',
    xp: 300,
    isMet: (s) => s.weeklyStreak >= 1,
  },
  {
    id: 'four-week-run',
    title: 'THE STANDARD',
    requirement: '4-week target streak (mulligans allowed)',
    reward: 'STANDARD-BEARER badge + cheat-meal token',
    rewardIcon: '🚩',
    xp: 800,
    isMet: (s) => s.weeklyStreak >= 4,
  },
  {
    id: 'streak-seven',
    title: 'UNBROKEN',
